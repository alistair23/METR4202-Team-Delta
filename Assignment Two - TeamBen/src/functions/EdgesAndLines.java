...
public class EdgesAndLines {

    private IplImage src;
	
    public EdgesAndLines (IplImage src) {
    	this.src = src;
    }
    
    public IplImage getEdges() {
    	IplImage dst;
    ...
    public IplImage getLines(String style) {
         ...
         */
        else if(style.contentEquals("multiscale")){
